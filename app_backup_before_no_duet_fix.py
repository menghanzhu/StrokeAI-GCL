...
def repeat_step_instruction_if_needed(
    ...
    """Speak step guidance only after the user starts the media stream."""
    if st.session_state.step_completed or not media_is_playing:
        return

    # Step 5 has its own prompt and delayed recording sequence.
    if step == 5:
        return
